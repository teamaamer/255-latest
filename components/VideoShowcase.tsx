    ...
    <section ref={ref} className="pt-0 pb-20 px-6 md:px-12 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-[var(--color-gray)] text-2xl max-w-2xl mx-auto font-semibold">
            Book a Consultation
          </p>
        </motion.div>

        {/* Facebook Video - Clickable to WhatsApp */}
        <motion.a
        ...
        >
          <div className="relative rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-300 group-hover:scale-105">
            ...
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-all duration-300 flex items-center justify-center pointer-events-none">
              <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-green-500 text-white px-8 py-4 rounded-full flex items-center gap-3 shadow-xl">
